...
cc.Class({
    ...
    onLoad: function () {
        ...
        Helper.http('http://3.80.4.14:9999/index.php/admin/api/imgs').then(e => {
    ...
    settingInit_Function: function () {
        ...
        var e = null;
        if (null === this.playerInfo.musicControl) {
            e = this.playerInfo.readData_Function("userSetting");
            ...
            if (null === e) {
                ...
                this.playerInfo.writeData_Function("userSetting", e);
                this.playerInfo.musicControl = e.musicControl;
                this.playerInfo.soundEffectControl = e.soundEffectControl;
                this.com_Setting.getChildByName("bt_MusicControl").isVoice = this.playerInfo.musiccontrol;
                this.com_Setting.getChildByName("bt_SoundEffectControl").isVoice = this.playerInfo.soundEffectControl;
                ...
                this.com_Setting.getChildByName("bt_MusicControl").isVoice = this.playerInfo.musiccontrol;
                this.com_Setting.getChildByName("bt_SoundEffectControl").isVoice = this.playerInfo.soundEffectControl;
                this.playerInfo.musicControl && (this.bgmNumber = cc.audioEngine.play(this.au_LobbyBGM, true, 1));
            }
        } else {
        ...
        if (this.playerInfo.musicControl) {
            this.com_Setting.getChildByName("bt_MusicControl").getComponent("cc.Sprite").spriteFrame = this.sp_settingControl[1];
            this.com_Setting.getChildByName("bt_MusicControl").getChildByName("sp_Control").setPosition(60, 0);
        } else {
            this.com_Setting.getChildByName("bt_MusicControl").getComponent("cc.Sprite").spriteFrame = this.sp_settingControl[0];
            this.com_Setting.getChildByName("bt_MusicControl").getChildByName("sp_Control").setPosition(-60, 0);
        }

        if (this.playerInfo.soundEffectControl) {
            this.com_Setting.getChildByName("bt_SoundEffectControl").getComponent("cc.Sprite").spriteFrame = this.sp_settingControl[1];
            this.com_Setting.getChildByName("bt_SoundEffectControl").getChildByName("sp_Control").setPosition(60, 0);
        } else {
            this.com_Setting.getChildByName("bt_SoundEffectControl").getComponent("cc.Sprite").spriteFrame = this.sp_settingControl[0];
            this.com_Setting.getChildByName("bt_SoundEffectControl").getChildByName("sp_Control").setPosition(-60, 0)
        }
    ...
    playerInfoMenuInit_Function: function () {
        for (let i = 12; i < this.com_PlayerInfo.children.length; ++i) {
            this.com_PlayerInfo.children[i].active = false;
        }
        //是不是正式注册用户
        if (this.playerInfo.isOffical) {
            this.com_PlayerInfo.getChildByName("bt_CreateAccount").active = false;
            this.com_PlayerInfo.getChildByName("com_CreateAccount").active = false;
            this.com_PlayerInfo.getChildByName("bt_ChangeName").active = true;
            this.com_PlayerInfo.getChildByName("bt_ChangeName").getComponent("cc.Button").interactable = false;
            this.com_PlayerInfo.getChildByName("com_ChangeName").active = true;
            this.com_PlayerInfo.getChildByName("com_ChangeName").getChildByName("lb_State").getComponent("cc.Label").string = i18n.t("账号状态已转正");
            this.com_PlayerInfo.getChildByName("com_ChangeName").getChildByName("lb_Account").getComponent("cc.Label").string = i18n.t("ZH_K") + ": " + this.playerInfo.account;
            this.com_PlayerInfo.getChildByName("com_ChangeName").getChildByName("lb_Id").getComponent("cc.Label").string = i18n.t("WJID_K") + ": " + this.playerInfo.playerId;
        } else {
            this.com_PlayerInfo.getChildByName("bt_CreateAccount").active = true;
            this.com_PlayerInfo.getChildByName("bt_CreateAccount").active = true;
            this.com_PlayerInfo.getChildByName("bt_CreateAccount").getComponent("cc.Button").interactable = false;
            this.com_PlayerInfo.getChildByName("com_CreateAccount").active = true;
            this.com_PlayerInfo.getChildByName("bt_ChangeName").active = false;
            this.com_PlayerInfo.getChildByName("com_ChangeName").active = false;
            this.com_PlayerInfo.getChildByName("com_ChangeName").getChildByName("lb_State").getComponent("cc.Label").string = "";
            this.com_PlayerInfo.getChildByName("com_ChangeName").getChildByName("lb_Account").getComponent("cc.Label").string = "";
            this.com_PlayerInfo.getChildByName("com_ChangeName").getChildByName("lb_Id").getComponent("cc.Label").string = "";
        }
        //是否绑定阿里账号
        if (this.playerInfo.isBindAli) {//是否显示按钮
            if (this.playerInfo.aliAccount) {//是否已绑定
                cc.find("com_MoneyBag/bt_BindAli", this.com_PlayerInfo).active = false;
                cc.find("com_MoneyBag/bt_BindedAli", this.com_PlayerInfo).active = true;
                this.playerInfo.encryptAliAccount = this.encryptString_Function(this.playerInfo.aliAccount, 3, 6);
                this.playerInfo.encryptAliName = this.encryptString_Function(this.playerInfo.aliName, 1, 3);
                this.com_PlayerInfo.getChildByName("com_BindedAli").getChildByName("lb_AccountInfo").getComponent("cc.Label").string = this.playerInfo.encryptAliAccount;
                this.com_PlayerInfo.getChildByName("com_BindedAli").getChildByName("lb_NameInfo").getComponent("cc.Label").string = this.playerInfo.encryptAliName;
            } else {
                cc.find("com_MoneyBag/bt_BindAli", this.com_PlayerInfo).active = true;
                cc.find("com_MoneyBag/bt_BindedAli", this.com_PlayerInfo).active = false;
                this.com_PlayerInfo.getChildByName("com_BindedAli").getChildByName("lb_AccountInfo").getComponent("cc.Label").string = "";
                this.com_PlayerInfo.getChildByName("com_BindedAli").getChildByName("lb_NameInfo").getComponent("cc.Label").string = "";
            }
        } else {
            cc.find("com_MoneyBag/bt_BindAli", this.com_PlayerInfo).active = false;
            cc.find("com_MoneyBag/bt_BindedAli", this.com_PlayerInfo).active = false;
        ...
        //是否绑银行卡
        if (this.playerInfo.isBindCreditCard) {
            cc.find("com_MoneyBag/bt_BindCreditCard", this.com_PlayerInfo).active = true;
        } else {
            cc.find("com_MoneyBag/bt_BindCreditCard", this.com_PlayerInfo).active = false;
        }
        //是否绑手机
        if (this.playerInfo.isBindPhone) {
            this.com_PlayerInfo.getChildByName("bt_BindPhone").active = true;
        } else {
            this.com_PlayerInfo.getChildByName("bt_BindPhone").active = false;
        }
        //金币余额是否小于50（分）
        if (this.playerInfo.playerCoin < 50) {
            this.com_Button.getChildByName("bt_PlusMall").getChildByName("tips").active = true;
        } else {
            this.com_Button.getChildByName("bt_PlusMall").getChildByName("tips").active = false;
        }

        if (2 === this.playerInfo.isAutoLogin) {
            this.com_PlayerInfo.getChildByName("bt_ChangeAccount").active = false;
            this.com_PlayerInfo.getChildByName("bt_ChangePassword").active = false;
    ...
    mallInit_Function: function (data) {
        this.rechargeMoneyArray = [];
        for (let i = 0; i < data.length; i++) {
            this.rechargeMoneyArray.push(parseInt(data[i].recharge_money));
            this.com_Mall.getChildByName("com_chongzhi_01").getChildByName("bt_Recharge" + i).rechargeId = i;
            this.com_Mall.getChildByName("com_chongzhi_01").getChildByName("bt_Recharge" + i).children[0].getComponent(cc.Label).string = Helper.fixNum(parseInt(data[i].recharge_money));
            this.com_Mall.getChildByName("com_chongzhi_01").getChildByName("bt_Recharge" + i).children[1].getComponent(cc.Label).string = "doar " + data[i].gift_money;
            this.com_Mall.getChildByName("com_chongzhi_02").getChildByName("bt_Recharge" + i).rechargeId = i;
            this.com_Mall.getChildByName("com_chongzhi_02").getChildByName("bt_Recharge" + i).children[0].getComponent(cc.Label).string = Helper.fixNum(parseInt(data[i].recharge_money));
            this.com_Mall.getChildByName("com_chongzhi_02").getChildByName("bt_Recharge" + i).children[1].getComponent(cc.Label).string = "doar " + data[i].gift_money;
        }
    },
    ...
    chatMessageInit_Function: function () {
        let view = this.com_Chat.getChildByName("chat_panel").getChildByName("scrollview").getComponent(cc.ScrollView).content;
    ...
    getMailInfo_Function: function (e) {
        ...
        if (this.playerInfo.mailList[e.node.buttonID].winScore > 0) {
            if (this.playerInfo.mailList[e.node.buttonID].nickName) {
                this.com_Mail.getChildByName("lb_MailInfo").getComponent("cc.Label").string += (this.playerInfo.mailList[e.node.buttonID].winScore / this.playerInfo.exchangeRate).toFixed(2) + " 金币";
            } else {
                this.com_Mail.getChildByName("lb_MailInfo").getComponent("cc.Label").string += "获得 " + (this.playerInfo.mailList[e.node.buttonID].winScore / this.playerInfo.exchangeRate).toFixed(2) + " 金币"
            }
        }
    },
    ...
    updateMailContent_Function: function () {
        let e = this.com_Mail.getChildByName("sv_Mail").getComponent("cc.ScrollView").content;
        let t = 0, i = -40;
        ...
        for (var n = 0; n < this.playerInfo.mailList.length; ++n) {
            e.children[n].buttonID = n;
            e.children[n].setPosition(t, i + n * -70);
        }

        if (this.playerInfo.mailList.length > 4) {
            e.height = 70 * this.playerInfo.mailList.length;
        } else {
            e.height = 320;
            0 === this.playerInfo.mailList.length && (this.com_Button.getChildByName("bt_Mail").getChildByName("tips").active = false);
        }
    ...
    bankIdInit_Function: function () {
        let e = this.com_PlayerInfo.getChildByName("com_AddCreditCard").getChildByName("sv_SelectBank").getComponent("cc.ScrollView").content;
        let t = this.com_PlayerInfo.getChildByName("com_EditCreditCard").getChildByName("sv_SelectBank").getComponent("cc.ScrollView").content;
        for (i = 0; i < e.childrenCount; ++i) {
            e.children[i].bankId = i;
    ...
    contentGameServerFail_Function: function (gameName) {
        ...
        switch (gameName) {
            ...
            case "kuailebuyu":
                errorMsg = "快乐捕鱼";
                break;
            case "Fishfengkuangbuyu":
                errorMsg = "疯狂捕鱼";
                break;
            case "Fishhaiwang3alading":
                errorMsg = "海王3阿拉丁";
                break;
        }
        ...
        if (!this.loadGameScene) {
            ...
            switch (gameName) {
                ...
                case "Roulette":
                    ...
                    break;
                case "Roulette36":
                    this.tempNetWork = require("Roulette36Net").getInstant;
                    break;
                case "Fish":
                ...
                case "Fishhaiwang2":
                    ...
                    break;
                case "Fishhaiwang3alading":
                    this.tempNetWork = require("Fishhaiwang3aladingNetWork").getInstant;
                    break;
                case "shenhaibuyu":
                ...
                case "kuailebuyu":
                    ...
                    break;
                case "Fishfengkuangbuyu":
                    this.tempNetWork = require("FishfengkuangbuyuNetWork").getInstant;
                    break;
            }
     ...
     * @param {*} type 
     */
    pay_Function: function (data, type) {
        if (!data.money || data.money < 50) return; //
        let url = "";
        if (type == 1) {
            url = `${this.playerInfo.apiIp}api/pay/kppay?payType=payment&uid=${this.playerInfo.playerId}&amount=${data.money}&payname=${data.name}&payemail=${data.email}&payphone=${data.phone}&paynumber=${data.account}`;
        } else if (type == 0) {
            url = `${this.playerInfo.apiIp}api/pay/fastpay?payType=payment&uid=${this.playerInfo.playerId}&amount=${data.money}&payname=${data.name}&payemail=${data.email}&payphone=${data.phone}`;
        }

        Helper.http(url, null, false).then(e => {
            console.log('得到服务器信息' + JSON.stringify(e));
            if (e.code == 1) {
                if (cc.sys.isNative) {
                    if (type == 1) {
                        cc.sys.openURL(e.data.data.payUrl);
                    } else {
                        cc.sys.openURL(e.data.order_data);
                    }
                } else {
                    ...
                    if (type == 1) {
                        web.url = e.data.data.payUrl;
                    } else {
                        web.url = e.data.order_data;
                    }
                }
            }
    ...
    withDraw_Function: function (money) {
        let url = "";
        if (window.withdrawalData.type == 1) {
            url = `${this.playerInfo.apiIp}/api/pay/kppay?payType=payout&uid=${this.playerInfo.playerId}&amount=${money}&acc_code=${window.withdrawalData.account}&payname=${window.withdrawalData.name}&payphone=${window.withdrawalData.phone}&payemail=${window.withdrawalData.email}`;
        } else if (window.withdrawalData.type == 0) {
            url = `${this.playerInfo.apiIp}api/pay/fastpay?payType=payout&uid=${this.playerInfo.playerId}&amount=${money}&acc_code=PHONE&acc_no=${window.withdrawalData.phone}&acc_name=${window.withdrawalData.name}`;
        }

        Helper.http(url, null, false).then(e => {
            console.log('得到服务器信息' + JSON.stringify(e));
            if (e.code == 1) {
                this.showMessagebox_Function("已提交提现申请", 1, 4);
            } else {
                this.showMessagebox_Function(e.msg.msg, 1, 4);
            }
    ...
    openChat(data) {
        if (this.com_Chat.active) {
            return;
        }
        if (data.userId == this.playerInfo.playerId) {
            this.showMessagebox_Function("无法对自己发起聊天", 1, 4);
            return;
        }
        this.com_Chat.active = true;
        this.chatUserId = data.userId;
        this.com_Chat.getChildByName("face_node").getChildByName("player").getChildByName("name_lab").getComponent(cc.Label).string = data.nickname;
        this.com_Chat.getChildByName("face_node").getChildByName("player").getChildByName("vip_lab").getComponent(cc.Label).string = "VIP " + data.housecard;
        this.com_Chat.getChildByName("chat_panel").getChildByName("scrollview").getComponent(cc.ScrollView).content.removeAllChildren();
        this.readChat_Function();
    },
     ...
     * @param {*} msg 
     */
    SendMessage_Function: function (userId, nickname, msg) {
        this.setChat_Function(userId, nickname, msg);
        this.writeChat_Function(userId, nickname, msg);
    },

    SendImg_Function: function (userId, nickname, msg) {
        this.setChat_Function(userId, nickname, "", msg);
        this.writeChat_Function(userId, nickname, "", msg);
    },
     ...
     * @param {*} message 
     */
    setChat_Function: function (userId, nickname, message, img) {
        let view = this.com_Chat.getChildByName("chat_panel").getChildByName("scrollview").getComponent(cc.ScrollView).content;
        var object = null;
        ...
        if (object) {
            Helper.loadHead(userId == this.playerInfo.playerId ? this.playerInfo.playerHeadId : 1, (texture) => {
            ...
            if (img) {
                ...
                image.onload = function () {
                    ...
                    object.getChildByName("chatSprite").getComponent(cc.Sprite).spriteFrame = spriteFrame;
                    object.getChildByName("chatSprite").parent.height = object.getChildByName("chatSprite").height + 80;
                }
                image.src = img;
            }
            ...
            this.com_Chat.getChildByName("chat_panel").getChildByName("scrollview").getComponent(cc.ScrollView).scrollToBottom(.5);
        }
    },
     ...
     * @param {*} message 
     */
    writeChat_Function: function (userId, nickname, message, img) {
    ...
    readChat_Function: function () {
        ...
        if (this.chatData != null) {
            for (var i = 0; i < this.chatData.length; i++) {
                if (this.chatUserId == this.chatData[i].toUserId) {
                    this.setChat_Function(this.chatData[i].userId, this.chatData[i].nickname, this.chatData[i].message, this.chatData[i].img);
                }
            }
    ...
    gameMenuBackButtonClick_Function: function () {
        ...
        var menuList = this.node.getComponent("LobbyMenu").com_GameMenu.getChildByName("Game_lconlist_box");
        //显示游戏按钮列表
        ...
        if (this.tempNetWork && this.tempNetWork.eventOn) {
            switch (this.playerInfo.gameName) {
                ...
                case "Fishhaiwang2":
                    ...
                    break;
                case "Fishhaiwang3alading":
                    this.tempNetWork.fishhaiwang3aladingSocket.disconnect();
                    this.tempNetWork.fishhaiwang3aladingSocket = null;
                    break;
                case "Shenhaibuyu":
                ...
                case "Leitingzhanji":
                    ...
                    break;
                case "Fishfengkuangbuyu":
                    this.tempNetWork.FishfengkuangbuyuSocket.disconnect();
                    this.tempNetWork.FishfengkuangbuyuSocket = null;
                    break;
            }
    ...
    setPoxyUI: function (result) {
        ...
        if (!!result.status && result.status == 1) {
            ...
            this.showMessagebox_Function(i18n.t("WBDDL_Z"), 1, 4);
        }
    },
    ...
    changeMallUI: function (id) {
        ...
        this.com_Mall.getChildByName('com_chongzhi_02').active = id == 1;

        this.com_Mall.getChildByName('btn_充值1').getComponent(cc.Button).interactable = id != 0;
        this.com_Mall.getChildByName('btn_充值2').getComponent(cc.Button).interactable = id != 1;

        this.com_Mall.getChildByName('btn_充值1').active = id == 0;
        this.com_Mall.getChildByName('btn_充值2').active = id == 1;

        Helper.http(this.playerInfo.apiIp + '/api/pay/paymentList').then(e => {
            cc.log('得到服务器信息' + JSON.stringify(e));
            if (e.code) {
                this.mallInit_Function(e.data);
            }
        });
