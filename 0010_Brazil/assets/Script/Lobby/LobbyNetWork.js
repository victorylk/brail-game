    ...
    anotherFunctionInit_Function: function () {
        ...
        self.socket.on("sendCoinResult", function (ret) {
            ...
            if (result.Result) {
                ...
                self.lobbyMain.com_PlayerMessage.getChildByName("lb_PlayerMoney").getComponent("cc.Label").string = self.playerInfo.playerCoin.toFixed(2);
                self.lobbyMain.getComponent("LobbyMain").com_bank.getComponent("LobbyBank").gift_playerCoin.string = self.playerInfo.playerCoin.toFixed(2);
                cc.find("Canvas/com_Withdrawal").getChildByName("lb_PlayerMoney").getComponent("cc.Label").string = self.playerInfo.playerCoin.toFixed(2);
                // self.lobbyMain.showMessagebox_Function("赠送成功", 1, 4);
            }
        }),
        ...
        self.socket.on("sendMsg", function (ret) {
            var result = self.changeResultJSON(ret);
            self.lobbyMain.openChat(result);
            self.lobbyMain.SendMessage_Function(result.userId, result.nickname, result.msg);
        });
        /**
         * 
         */
        self.socket.on("sendImgMsg", function (ret) {
            var result = self.changeResultJSON(ret);
            self.lobbyMain.openChat(result);
            self.lobbyMain.SendImg_Function(result.userId, result.nickname, result.img);
        });
        ...
        self.socket.on("sendMsgToUserResult", function (ret) {
            ...
            if (result.ResultCode) {
                ...
                self.lobbyMain.SendMessage_Function(self.playerInfo.playerId, self.playerInfo.playerName, self.lobbyMain.sendMessage);
        ...
        self.socket.on("sendImgMsgToUserResult", function (ret) {
            ...
            if (result.ResultCode) {
                ...
                self.lobbyMain.SendImg_Function(self.playerInfo.playerId, self.playerInfo.playerName, self.lobbyMain.chatImg);
                self.lobbyMain.chatImg = "";
            }
        });
            ...
            if (!result.ResultCode) {
                ...
                if (result.data.chatList) {
                    for (var i = 0; i < result.data.chatList.length; i++) {
                        self.lobbyMain.openChat(result.data.chatList[i]);
                        self.lobbyMain.SendMessage_Function(result.data.chatList[i].userId, result.data.chatList[i].nickname, result.data.chatList[i].msg);
        ...
        self.socket.on("getPlayerCoinResult", function (ret) {
            ...
            if (result.ResultCode) {
                ...
                self.lobbyMain.getComponent("LobbyMain").showMessagebox_Function(i18n.t(result.msg), 1, 4);
            }
        });
        ...
        */
        self.socket.on("updateBankpwdResult", function (ret) {
            ...
            if (result.ResultCode) {
                ...
                self.lobbyMain.getComponent("LobbyMain").showMessagebox_Function(i18n.t("修改失败"), 1, 4);
            }
        });
        ...
        self.socket.on("updateNickNameResult", function (ret) {
            ...
            if (result.Result) {
                self.lobbyMain.com_PlayerInfo.getChildByName("com_ChangeName").getChildByName("eb_Name").getComponent("cc.EditBox").string = i18n.t("修改失败");
            } else {
                ...
                self.lobbyMain.com_PlayerInfo.getChildByName("com_ChangeName").getChildByName("lb_Account").getComponent("cc.Label").string = i18n.t("ZH_K") + ": " + self.playerInfo.account;
                self.lobbyMain.showMessagebox_Function(i18n.t(result.msg), 1, 4);
            }
        });
        ...
        self.socket.on("bindZhifubaoResult", function (ret) {
            ...
            if (result.Result) {
                ...
                cc.find("com_MoneyBag/bt_BindAli", self.lobbyMain.com_PlayerInfo).active = false;
                cc.find("com_MoneyBag/bt_BindedAli", self.lobbyMain.com_PlayerInfo).active = true;
                cc.find("com_MoneyBag/bt_BindedAli", self.lobbyMain.com_PlayerInfo).getComponent("cc.Button").interactable = false;
        ...
        self.socket.on("changeOfficialResult", function (ret) {
            ...
            if (result.ResultCode) {
                self.lobbyMain.com_PlayerInfo.getChildByName("com_CreateAccount").getChildByName("lb_Tips0").getComponent("cc.Label").string = i18n.t("操作失败");
            } else {
                var data = {
                ...
                self.lobbyMain.getComponent("LobbyRegister").writeUserDate_Function(data, function () {
                    ...
                    self.lobbyMain.com_PlayerInfo.getChildByName("com_ChangeName").getChildByName("lb_State").getComponent("cc.Label").string = i18n.t("账号状态已转正");
                    self.lobbyMain.com_PlayerInfo.getChildByName("com_ChangeName").getChildByName("lb_Account").getComponent("cc.Label").string = i18n.t("ZH_K") + ": " + self.playerInfo.account;
                    self.lobbyMain.com_PlayerInfo.getChildByName("com_ChangeName").getChildByName("lb_Id").getComponent("cc.Label").string = i18n.t("WJID_K") + ": " + self.playerInfo.playerId;
                    self.lobbyMain.com_PlayerInfo.active = false;
                    self.lobbyMain.showMessagebox_Function(i18n.t("ZZCG_K"), 1, 4);
        ...
        self.socket.on("updatePasswordResult", function (ret) {
            ...
            if (result.ResultCode) {
                self.lobbyMain.com_PlayerInfo.getChildByName("com_ChangePassword").getChildByName("lb_Tips0").getComponent("cc.Label").string = i18n.t("修改失败");
            } else {
                var data = {
                ...
                self.lobbyMain.getComponent("LobbyRegister").writeUserDate_Function(data, function () {
                    ...
                    self.lobbyMain.com_PlayerInfo.active = false;
                    self.lobbyMain.showMessagebox_Function(i18n.t("修改成功"), 1, 4);
                })
            }
        });
        ...
        self.socket.on('updateHeadUrlResult', ret => {
            ...
            self.lobbyMain.showMessagebox_Function(i18n.t(result.msg), 1, 0);
        });
        ...
        self.socket.on("withdraw_applyResult", (ret) => {
            ...
            switch (result.ResultCode) {
                case 0:
                    self.lobbyMain.withDraw_Function(result.money);
                    break;
                case 1:
                    self.lobbyMain.showMessagebox_Function("申请提交失败", 1, 4);
                    break;
                case 2:
                    self.lobbyMain.showMessagebox_Function("未绑定银行卡", 1, 4);
                    break;
                case 3:
                    self.lobbyMain.showMessagebox_Function("余额不足", 1, 4);
                    break;
            }
        });
