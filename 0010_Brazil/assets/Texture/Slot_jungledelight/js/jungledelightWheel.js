...
cc.Class({
    ...
    onLoad() {
        this.audio = cc.director.getScene().getChildByName('Canvas').getComponent('jungledelightAudio');
        this.mainObj = cc.director.getScene().getChildByName('Canvas').getComponent('jungledelightMain');
    ...
    addClickEvent(node, idx) {
        ...
        clickEventHandler.component = "jungledelightWheel";// 这个是代码文件名
    ...
    roleClick: function (event, customEventData) {
        ...
        newNode.getComponent("jungledelightDetail").init(customEventData, isLeft);
