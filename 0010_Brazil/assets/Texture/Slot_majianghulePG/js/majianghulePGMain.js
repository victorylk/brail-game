...
cc.Class({
    ...
    onLoad() {
        ...
        this.net = this.node.getComponent('majianghulePGNetwork');
    ...
    showAnim(cols, index) {
        ...
        this.scheduleOnce(() => {
            ...
            this.scheduleOnce(() => {
                ...
                nodeList[cols * 4 + 3 - index].active = true;
                let spineNode = nodeList[cols * 4 + 3 - index].children[0].getComponent(sp.Skeleton);
        ...
        //添加结束
        let nodeList2 = this.winEffectNode.children;
        nodeList2[cols * 4 + 3 - index].active = true;
        let nodeList3 = this.maskEffectNode.children;
        nodeList3[cols * 4 + 3 - index].active = false;
    },
    ...
    closeAnim(cols, index) {
        ...
        //添加结束
        let nodeList = this.boomEffectNode.children;
        nodeList[cols * 4 + 3 - index].active = false;
    },
            ...
            if (key != 0) {
                ...
                for (let i in hCards) {
                    ...
                    for (let j = 0; j < list[key]["goldCards"].length; j++) {
                        if (list[key]["goldCards"][j] == 19 - i) {
                            line[4 - (i % 5)][parseInt(i / 5)] = hCards[19 - i] + 100;
                        }
                    }
                }
            }
