...
cc.Class({
    ...
    onLoad() {
        ...
        this.lastResult = [0, 0, 0, 0]; //三位是上一局结果
    ...
    startRoll(...args) {
        ...
        setTimeout(() => {
            ...
            this.node.runAction(
                cc.sequence(
                    //cc.delayTime(0.2),
                    cc.moveTo(timer, cc.v2(this.node.x, -this.node.height + 720)),
    ...
    rollCallBack() {
        ...
        this.lastResult = this.roleIdList.slice(0, 4);
    ...
    stopImmediately() {
        ...
        setTimeout(() => {
            this.node.y = -this.node.height + 720;
            this.rollCallBack();
        }, 50);
    },
