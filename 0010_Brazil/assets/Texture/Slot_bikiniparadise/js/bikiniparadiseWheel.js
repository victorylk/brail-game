...
cc.Class({
    ...
    onLoad() {
        this.audio = cc.director.getScene().getChildByName('Canvas').getComponent('bikiniparadiseAudio');
        this.mainObj = cc.director.getScene().getChildByName('Canvas').getComponent('bikiniparadiseMain');
