...
Csocket.on('connected', function (msg) {
    ...
    var info = {
        serverName: "拉霸游戏_" + (239) + "_" + gameConfig.gameName,
...
io.on('connection', function (socket) {
    ...
    socket.on('lottery', function (lottery) {
        ...
        var result = gameInfo.lottery(socket.userId, lottery.bet, lottery.nBetList);
        if (result.code < 1) {
...
// console.log("拉霸_36_钻石服务器启动");
console.log("拉霸_" + 239 + "_" + gameConfig.gameName + "服务器启动");
