...
var GameInfo = function () {
    ...
    var Game = function () {
        ...
        this.lottery = function (_userId, _betIdx) {
            ...
            if (!gameConfig.coinConfig[_betIdx]) {
            ...
            //======================================================================================
            // 下注总额
            var nBetSum = gameConfig.coinConfig[_betIdx];
            ...
            while (true) {
                ...
                let win = gameConfig.GAME_MUL_TURNTABLE[_betIdx][winIndex];
            ...
            var winscore = parseInt(dictAnalyseResult["win"]);
