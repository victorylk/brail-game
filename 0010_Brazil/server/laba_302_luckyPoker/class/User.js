User = function (userInfo, _socket) {
    ...
    this.sign = "";
    this._isLeave = true;
    this.isFinal = false;//是否连胜
    this.originalArray = [];//原牌数组
    this._curWinScore = 0;//当前赢得得金币数
    this._curWinTimes = 0;//当前赢得次数
    ...
    this.setOriginalArray = function (data) {
    ...
    this.setCurWinScore = function (data) {
        this._curWinScore = data;
    };

    this.getCurWinScore = function () {
        return this._curWinScore;
    };

    this.setCurWinTimes = function (data) {
        this._curWinTimes = data;
    };

    this.getCurWinTimes = function () {
        return this._curWinTimes;
    };
