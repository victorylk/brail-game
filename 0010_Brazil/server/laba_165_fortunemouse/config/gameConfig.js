...
gameConfig = {};
gameConfig.gameId = 265;			//第几个游戏ID
gameConfig.serverId = 15165;		//当前游戏的第几台服务器
gameConfig.logflag = 15165;		//游戏记录表示
gameConfig.port = 15165;		//游戏记录表示
gameConfig.gameName = "fortunemouse";
...
gameConfig.GAME_COLORS_DIAMOND = [0, 1, 2, 3, 4, 5, 6];
gameConfig.Free_GAME_COLORS_DIAMOND = [0, 1, 2, 3, 4, 5, 6];
