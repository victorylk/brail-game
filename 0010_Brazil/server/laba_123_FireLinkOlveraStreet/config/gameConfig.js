...
gameConfig = {};
gameConfig.gameId = 223;			//第几个游戏ID
gameConfig.serverId = 15123;		//当前游戏的第几台服务器
gameConfig.logflag = 15123;		//游戏记录表示
gameConfig.port = 15123;		//游戏记录表示
gameConfig.gameName = "FireLinkOlveraStreet";
