...
gameConfig = {};
gameConfig.gameId = 222;			//第几个游戏ID
gameConfig.serverId = 15122;		//当前游戏的第几台服务器
gameConfig.logflag = 15122;		//游戏记录表示
gameConfig.port = 15122;		//游戏记录表示
gameConfig.gameName = "FireLinkRR";
