User = function (userInfo, _socket) {
    ...
    this.TableId = -1;			//桌子ID
    this.SeatId = -1;			//座位ID
    this.isBigWin = false;      //是否大奖模式
    this._bigWinData = null;    //大奖数据
    this.sign = "";
    this._isLeave = true;
    ...
    this.updateFreeGame = function (_userInfo) {
        if (_userInfo.Id == this._userId) {
            ...
            this.freeType = _userInfo.freeType ? _userInfo.freeType : 0;
    ...
    //设置免费游戏模式
    this.SetFreeType = function (_type) {
        this.freeType = _type;
    };
    ...
    //获得免费游戏模式
    this.getFreeType = function () {
        return this.freeType;
    };

    //获得大奖手牌
    this.getBigWinData = function () {
        return this._bigWinData;
    };

    //设置大奖手牌
    this.setBigWinData = function (data) {
        this._bigWinData = data;
    };
