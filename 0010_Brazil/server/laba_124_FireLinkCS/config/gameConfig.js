...
gameConfig = {};
gameConfig.gameId = 224;			//第几个游戏ID
gameConfig.serverId = 15124;		//当前游戏的第几台服务器
gameConfig.logflag = 15124;		//游戏记录表示
gameConfig.port = 15124;		//游戏记录表示
gameConfig.gameName = "FireLinkCS";
...
gameConfig.Free_GAME_COLORS_DIAMOND = [0, 1, 2, 3, 4, 5, 6, 7, 8, gameConfig.GAME_MAGIC_CARD_DIAMOND];//免费花色
