    ...
    var Game = function () {
        ...
        this.lottery = function (_userId, _betIdx) {
            ...
            while (true) {
                ...
                if (parseInt(dictAnalyseResult["win"]) === 0 || parseInt(dictAnalyseResult["win"]) < parseInt(jackpotUpperLimit)) {
                    break_check = true;
                }

                if (break_check && !dictAnalyseResult["getFreeTime"]["bFlag"]) {
                    break_check = true;
                } else {
                    if (break_check) {
                        if (dictAnalyseResult["getFreeTime"]["bFlag"] && is_luck) {
