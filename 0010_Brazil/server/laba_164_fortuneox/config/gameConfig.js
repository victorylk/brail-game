...
gameConfig = {};
gameConfig.gameId = 264;			//第几个游戏ID
gameConfig.serverId = 15164;		//当前游戏的第几台服务器
gameConfig.logflag = 15164;		//游戏记录表示
gameConfig.port = 15164;		//游戏记录表示
gameConfig.gameName = "fortuneox";
