...
gameConfig = {};
gameConfig.gameId = 269;			//第几个游戏ID
gameConfig.serverId = 15169;		//当前游戏的第几台服务器
gameConfig.logflag = 15169;		//游戏记录表示
gameConfig.port = 15169;		//游戏记录表示
gameConfig.gameName = "麻将胡了PG";
