...
var GameInfo = function () {
    ...
    var Game = function () {
        ...
        this.init = function () {
            ...
            if (http_bc) {
                http_bc.addTreasureBoxGold((data) => {
                    for (let i in data) {
                        var userInfo = {
                            sendUserId: parseInt(data[i].ChannelType),
                            sendCoin: data[i].addGold,
                            change_type: 66
                        };
            ...
            var j = schedule.scheduleJob(rule, function () {
                ...
                if (now_hours == 23 && minute == 0 && second == 0) {    //斗地主比赛场统计
                    ...
                    landlord_race_dao.query_race_record_for_sort({
                        ...
                        if (state) {
                            ...
                            console.log("斗地主比赛场排位---------------------")
                            console.log(self.landload_race_sort)
                ...
                if (now_hours === 0 && minute === 0 && second === 0) {
                    if (http_bc) {
                        http_bc.addTreasureBoxGold((data) => {
                            for (let i in data) {
                                var userInfo = {
